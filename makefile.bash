...
if !(test -x $PLAY_FILE)
then
    chmod u+x PlayConnect.bash
    echo -e "\nYou now own the PlayConnect.bash script"
elif test -x $PLAY_FILE
then
    echo -e "\nYou already own the PlayConnect.bash script"
fi

    echo -e "Now enter./PlayConnect.bash into command line to play!\n"
